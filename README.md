# <h1 align="center"> 😊 Mood 😊 </h1>
This is a simple super simple project that allow us to set the mood or get the last mood seted in a Smart Contract deployed on the Ropsten testnet 
